    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Always go back to login (replace current)
            ...
            : _errorMessage != null
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isVerified ? const Color(0xFF4CAF50) : const Color(0xFFFFA726),
                      width: 1.5,
                    ),
                  ),
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              isVerified ? 'Account Verified' : 'Account Pending',
                              style: TextStyle(
                                color: isVerified ? const Color(0xFF2E7D32) : const Color(0xFFF57C00),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                color: isVerified ? const Color(0xFF388E3C) : const Color(0xFFEF6C00),
                                fontSize: 13,
                              ),
                            ),
                          ],
                ...
                // Small stats cards row - WITH API DATA
                Row(
                ...
                Row(
                  ...
                  children: [
                    _StatCard(
                      ...
                      value: 'LKR ${_stats?.todayRevenue.toStringAsFixed(0) ?? '0'}',
                    ...
                    _StatCard(
                      ...
                      value: '${_stats?.occupancyRate.toStringAsFixed(1) ?? '0'}%',
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    // Show Add Reservations only for non-staff
                ...
                // Show Management section only for non-staff
                if (!RoleManager().isStaff) ...[
                  const Text(
                    'Management',
                    style: TextStyle(
