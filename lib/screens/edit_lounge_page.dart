      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInputField(Icons.attach_money, "Price per Hour", _priceController),
            _buildInputField(Icons.business_center, "Facilities", _facilitiesController),
              ...
              child: Container(
                ...
                child: const Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.add_photo_alternate_outlined, color: Colors.orange, size: 30),
                      SizedBox(height: 8),
                      Text("Add photos", style: TextStyle(color: Colors.orange)),
                    ],
                  ),
                ),
              ),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("Lounge updated successfully!")),
                  );
